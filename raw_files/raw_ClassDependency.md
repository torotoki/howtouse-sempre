This is a result running the command `jdeps -v -package edu.stanford.nlp.sempre *.class` at the directory contains class files. We strongly recommend you to use `grep` to find something.
